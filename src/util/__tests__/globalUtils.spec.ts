...
describe( 'useImageError', () => {
  ...
  describe( 'with string URL', () => {
    ...
    it( 'should handle N/A poster value', () => {
      ...
      expect( imageSrc.value ).toBe( 'https://via.placeholder.com/300x450/cccccc/666666?text=No+Image' );
    } );
    ...
    it( 'should handle first image error correctly', () => {
      const { imageSrc, imageError, showEmojiPlaceholder, onImageError } = useImageError( 'invalid-image.jpg' );
    ...
    it( 'should reset state correctly', () => {
      const { imageError, showEmojiPlaceholder, onImageError, resetImageState } = useImageError( 'test-image.jpg' );
  ...
  describe( 'with function URL', () => {
    ...
    it( 'should react to URL changes and reset state', async () => {
      ...
      const { imageSrc, imageError, showEmojiPlaceholder, onImageError, resetImageState } = useImageError( getUrl );
